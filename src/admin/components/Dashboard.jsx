            ...
            <div className="flex-1">
                ...
                <div className="flex justify-between items-center gap-6 mt-8">
                    <div className="bg-white p-12 pt-8 tsteam__global--border h-96">
                        <div>
                            <h2 className="text-3xl font-bold">Enhance Your TS Product Showcase Plugin</h2>
                            <p className="text-base mt-4">Maximize the potential of your TS Product Showcase WordPress plugin with our curated resources.</p>
                        </div>

                        <div className="grid grid-cols-3 gap-6 mt-4">
                            <div className="tsteam__dasboard--card tsteam__global--border">
                                <h4 className="text-xl">{translations.documentations}</h4>
                                <p className="mt-4 mb-4">Dive into detailed guides and tutorials to set up and customize your TS Product Showcase plugin.</p>
                            ...
                            <div className="tsteam__dasboard--card tsteam__global--border">
                                ...
                                <p className="mt-4 mb-4">Watch easy-to-follow video tutorials to master the TS Product Showcase plugin.</p>
                                <a href="">Coming Soon</a>
                            </div>
                        </div>
                    </div>
